...
/* harmony import */ var _modules_init_submenu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-submenu */ "./js/modules/init-submenu.js");
/* harmony import */ var _modules_init_btn_to_top__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-btn-to-top */ "./js/modules/init-btn-to-top.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_submenu__WEBPACK_IMPORTED_MODULE_5__["initSubmenu"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_btn_to_top__WEBPACK_IMPORTED_MODULE_6__["initBtnToTop"])();
  });
});
  ...
  if (burgerBtns.length) {
    ...
    burgerBtns.forEach(function (burgerBtn) {
      ...
      menuBody.addEventListener('click', function (e) {
        var burgerLinks = menuBody.querySelectorAll('.main-nav__link');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSubmenu", function() { return initSubmenu; });
// Подменю в бургер-меню -- Начало --
// Burger submenu -- Start --

function initSubmenu() {
  var submenuBtns = document.querySelectorAll('[data-submenu-toggle]');
  if (submenuBtns.length) {
    var submenuBody = document.querySelector('[data-submenu-body]');
    submenuBtns.forEach(function (submenuBtn) {
      submenuBtn.addEventListener('click', function () {
        submenuBtn.nextElementSibling.classList.add('is-active');
      });
      submenuBody.addEventListener('click', function (e) {
        var links = submenuBody.querySelectorAll('.main-nav__sublink');
        var backBtn = submenuBody.querySelector('.main-nav__submenu-back');
